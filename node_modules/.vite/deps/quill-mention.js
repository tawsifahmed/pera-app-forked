...
var MentionBlot = function(_Embed) {
  ...
  function MentionBlot2() {
    _classCallCheck(this, MentionBlot2);
    return _super.apply(this, arguments);
  }
  _createClass(MentionBlot2, null, [{
    key: "create",
...
import_quill.default.register(MentionBlot);
var Mention = function() {
  ...
  _createClass(Mention2, [{
    ...
    value: function insertItem(data) {
      ...
      this.quill.insertEmbed(prevMentionCharPos, this.options.blotName, render, import_quill.default.sources.USER);
      if (this.options.spaceAfterInsert) {
        this.quill.insertText(prevMentionCharPos + 1, " ", import_quill.default.sources.USER);
        this.quill.setSelection(prevMentionCharPos + 2, import_quill.default.sources.USER);
      } else {
        this.quill.setSelection(prevMentionCharPos + 1, import_quill.default.sources.USER);
      }
      this.hideMentionList();
    }
  }, {
...
var quill_mention_esm_default = Mention;
export {
  quill_mention_esm_default as default
};
