...
const { registerInviteUser } = useAuthStore(); // use authenticateUser action from  auth store
...
const empId = ref(route.params.register);
definePageMeta({
    layout: false
});
...
const handleLoginSubmit = async () => {
    createUser.value.id = empId.value;
                ...
                <div class="w-full surface-card py-8 px-5 sm:px-8" style="border-radius: 53px">
                    ...
                    <form @submit.prevent="handleLoginSubmit">
                        <div class="field md:w-28rem mb-4">
                            ...
                            <small id="name-help" class="error-report" v-if="errorData.userNameError"> <InputIcon class="pi pi-exclamation-triangle"></InputIcon> Full name required! </small>
                        </div>
                        <div class="field md:w-28rem mb-4">
                            <label for="email" class="block text-900 text-xl font-medium mb-2">Work Email</label>
                            <InputText disabled id="email" v-model="createUser.email" type="email" placeholder="example@gmail.com" class="w-full" style="padding: 1rem" />
                            <small id="email-help" class="error-report" v-if="errorData.emailError"> <InputIcon class="pi pi-exclamation-triangle"></InputIcon> Email required! </small>
                        </div>
                        <div class="field md:w-28rem mb-4">
                            ...
                            <small id="password-help" class="error-report" v-if="errorData.passwordError"> <InputIcon class="pi pi-exclamation-triangle"></InputIcon> Password required! </small>
                        </div>
                        <div class="field md:w-28rem mb-4">
                            ...
                            <small id="password-help" class="error-report" v-if="errorData.confirmPassError"> <InputIcon class="pi pi-exclamation-triangle"></InputIcon> Confirm Password required! </small>
                        </div>
