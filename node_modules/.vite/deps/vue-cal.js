...
var EventUtils = class {
  ...
  createAnEvent(dateTime, duration, eventOptions) {
    if (typeof dateTime === "string")
      dateTime = ud.stringToDate(dateTime);
  ...
  removeEventSegment(e) {
    ...
    if (segmentsCount <= 1)
      return ud.formatDateLite(e.end);
    ...
    cellEvents.forEach((e) => {
      ...
      _comparisonArray.forEach((e2) => {
        if (!_cellOverlaps[e2._eid])
          _cellOverlaps[e2._eid] = { overlaps: [], start: e2.start, position: 0 };
        ...
        if (!e.background && !e.allDay && !e2.background && !e2.allDay && eventIsInRange && eventsInSameTimeStep) {
          ...
          let pos1, pos2;
          if ((pos1 = (_cellOverlaps[e._eid] || { overlaps: [] }).overlaps.indexOf(e2._eid)) > -1)
            _cellOverlaps[e._eid].overlaps.splice(pos1, 1);
          if ((pos2 = (_cellOverlaps[e2._eid] || { overlaps: [] }).overlaps.indexOf(e._eid)) > -1)
    ...
    checkCellOverlappingEvents() {
      if (this.options.time && this.eventsCount && !this.splitsCount) {
        if (this.eventsCount === 1) {
          ...
          [this.cellOverlaps, this.cellOverlapsStreak] = this.utils.event.checkCellOverlappingEvents(this.events, this.options);
      }
    },
...
var _sfc_main = {
  ...
  methods: {
    ...
    async loadLocale(locale) {
      ...
      const texts = await __variableDynamicImportRuntimeHelper(Object.assign({ "./i18n/ar.json": () => import("./ar.es-JOTKW7L7.js"), "./i18n/bg.json": () => import("./bg.es-I7GWEC3H.js"), "./i18n/bn.json": () => import("./bn.es-KNAQPDLZ.js"), "./i18n/bs.json": () => import("./bs.es-IDOUH6U5.js"), "./i18n/ca.json": () => import("./ca.es-U2ZBHSJJ.js"), "./i18n/cs.json": () => import("./cs.es-DII3QAOQ.js"), "./i18n/da.json": () => import("./da.es-WBIGAMA6.js"), "./i18n/de.json": () => import("./de.es-KS3BFAOS.js"), "./i18n/el.json": () => import("./el.es-NNWZGV5H.js"), "./i18n/en.json": () => import("./en.es-3YC7KSRF.js"), "./i18n/es.json": () => import("./es.es-EOZZKJNX.js"), "./i18n/et.json": () => import("./et.es-CSGKWU3M.js"), "./i18n/fa.json": () => import("./fa.es-HENW2NM7.js"), "./i18n/fi.json": () => import("./fi.es-2HLC6ARH.js"), "./i18n/fr.json": () => import("./fr.es-EQM52H4V.js"), "./i18n/he.json": () => import("./he.es-H7BPXJHX.js"), "./i18n/hr.json": () => import("./hr.es-KECEWPVL.js"), "./i18n/hu.json": () => import("./hu.es-UQFYSRSF.js"), "./i18n/id.json": () => import("./id.es-FRZXVIVC.js"), "./i18n/is.json": () => import("./is.es-AH46PM7L.js"), "./i18n/it.json": () => import("./it.es-OFDC4RCO.js"), "./i18n/ja.json": () => import("./ja.es-BGEVPHRF.js"), "./i18n/ka.json": () => import("./ka.es-ULWHIS2F.js"), "./i18n/ko.json": () => import("./ko.es-UV3SMAG4.js"), "./i18n/lt.json": () => import("./lt.es-CVWZMC6A.js"), "./i18n/mn.json": () => import("./mn.es-SP6BHLUR.js"), "./i18n/nl.json": () => import("./nl.es-XP5V23BE.js"), "./i18n/no.json": () => import("./no.es-HP4ZNA2O.js"), "./i18n/pl.json": () => import("./pl.es-DND3WOMU.js"), "./i18n/pt-br.json": () => import("./pt-br.es-32YKD4MJ.js"), "./i18n/pt-pt.json": () => import("./pt-pt.es-VI2S4GMV.js"), "./i18n/ro.json": () => import("./ro.es-CLXULKTK.js"), "./i18n/ru.json": () => import("./ru.es-D4Z4EPIA.js"), "./i18n/sk.json": () => import("./sk.es-FDPUY2OK.js"), "./i18n/sl.json": () => import("./sl.es-OOQU7BTZ.js"), "./i18n/sq.json": () => import("./sq.es-7LF2ISYM.js"), "./i18n/sr.json": () => import("./sr.es-YM3L5YKJ.js"), "./i18n/sv.json": () => import("./sv.es-R5PP6Q62.js"), "./i18n/tr.json": () => import("./tr.es-L3FAFQWV.js"), "./i18n/uk.json": () => import("./uk.es-WRD64YCP.js"), "./i18n/vi.json": () => import("./vi.es-EX2PCSWD.js"), "./i18n/zh-cn.json": () => import("./zh-cn.es-XH2243KT.js"), "./i18n/zh-hk.json": () => import("./zh-hk.es-IM2QRVQF.js") }), `./i18n/${locale}.json`, 3);
     ...
     */
    loadDragAndDrop() {
      import("./drag-and-drop.es-RGHIVLWC.js").then((response) => {
...
A valid view must be one of: ${validViews.join(", ")}.`);
    ...
    onMouseUp(e) {
      ...
      if (eventClicked && !hasResized && !isClickHoldingEvent && !dragCreatedEvent && eventClickHandler) {
        ...
        if (!event && this.isMonthView)
          event = this.view.outOfScopeEvents.find((e2) => e2._eid === focusAnEvent._eid);
    ...
    updateMutableEvents() {
      ...
      this.events.forEach((event) => {
        ...
        if (typeof event.end === "string" && event.end.includes("24:00")) {
          ...
          end = typeof event.end === "string" ? ud2.stringToDate(event.end) : event.end;
  ...
  computed: {
    ...
    maxTimestamp() {
      ...
      else if (this.maxDate && this.maxDate instanceof Date)
        date = this.maxDate;
      return date ? date.getTime() : null;
    },
    weekDays() {
        ...
        case "week": {
          ...
          if (lastDayOfWeek.getMonth() !== date.getMonth()) {
            ...
            if (y1 === y2)
              ...
              if (this.small)
                formattedMonthYear = `${m1.substring(0, 3)} ${y1} - ${m2.substring(0, 3)} ${y2}`;
              else
