...
<template>
    <div class="card">
        ...
        <DataTable v-model:filters="filters" class="table-dsp" :value="singleSpaceProjects" stripedRows paginator tableStyle="min-width: 50rem" :rows="20" :rowsPerPageOptions="[5, 10, 20, 30, 50]" dataKey="id" filterDisplay="menu" :loading="loading">
            <template #empty>
